...
export default function Home() {
  ...
  const BASE_URL = "https://decision-tree-diabetes-risk-prediction.onrender.com";
      ...
      <header className="max-w-7xl mx-auto mb-8">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">DiabetesPredict AI based on Decision tree</h1>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <div className="flex items-center space-x-2 bg-white px-4 py-2 rounded-xl shadow-sm">
              ...
              <span className="text-sm text-black font-medium">87.8% Accuracy</span>
            </div>
            <div className="flex items-center space-x-2 bg-white px-4 py-2 rounded-xl shadow-sm">
